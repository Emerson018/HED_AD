    ...
    <ThemeProvider theme={getTheme('light')}>
      ...
      >
        <Container maxWidth="sm" sx={{ py: 4 }}>
          <Paper elevation={10} sx={{ p: 4, borderRadius: 4, bgcolor: 'background.paper' }}>
            ...
            <Box sx={{ mt: 3, textAlign: 'center' }}>
              <Typography variant="body2">
                Já tem uma conta? <Link to="/login" style={{ textDecoration: 'none', color: '#003B67', fontWeight: 'bold' }}>Fazer Login</Link>
              </Typography>
            </Box>
          </Paper>
        </Container>
